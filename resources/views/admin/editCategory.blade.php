...
<div class="content-page">
                <!-- Start content -->
                <div class="content">
                <form action="/editCategory" method="POST" id="submit_form"> 
                {{ csrf_field() }}
                            ...
                            <div class="col-lg-6 col-xs-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="#">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="description" value="{{$category->name}}" class="form-control" placeholder="Enter Description">
                                            </div> 
                                            <div class="form-group">
                                                <label>Image</label>
                                ...
                                <div class="text-right mr-2 mb-2">
                                 <a href="/category"  class="btn btn-secondary waves-effect waves-light">Cancel</a>
                                    <button type="button" id="submit_btn" class="btn btn-dark waves-effect waves-light">Update</button>
